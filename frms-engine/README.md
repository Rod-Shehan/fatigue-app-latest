...
4. **Settings → Networking → Generate Domain** → copy URL (e.g. `https://frms-engine-production.up.railway.app`)
5. Confirm health: `https://YOUR-DOMAIN/health` → `{"status":"ok","engine":"frms-py-1"}`
