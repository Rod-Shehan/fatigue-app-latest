/**
 * Unified Autonomise triage trigger categories — single source of truth.
 * Used for dismiss (F1), verified distraction (F3), and spreadsheet export on any event type.
 * Add new categories here only; they apply to all triage reason capture flows.
 */
