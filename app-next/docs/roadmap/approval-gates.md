...
| **S6** | Roadside: PDF summary + optional QR (substance first) | Approve UX + **legal copy** | **Done 2026-03-18**; **print extras dropped 2026-08-20** — trip-sheet PDFs only; snapshot API still exists |
...
| 2026-08-20 | S6 | Week Export PDF and roadside produce print trip-sheet pages only (no compliance summary / QR / shift-log appendix on the PDF). |
