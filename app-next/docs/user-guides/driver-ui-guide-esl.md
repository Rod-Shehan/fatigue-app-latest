...
- **2. Emails & workshop** — **Checklist PDF email** (your address for Fitness for Work / Vehicle pre-departure / Trailer pre-departure / Forklift pre-departure / Dimension & Load week packs; defaults to your **sign-in email**) and **Workshop contact** (vehicle faults only — WAHVA). Not the 28-day fatigue roadside PDF.
