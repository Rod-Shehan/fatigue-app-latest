...
4. Optionally tick **Daily checks**, or open signed **Fitness for Work** / **Vehicle pre-departure** / **Trailer pre-departure** / **Forklift pre-departure** / **Load check** / **Hook up** forms (optional in trial — do not block Start shift). Those three pre-departure forms stay **separate**. Daily checks ticks (**Fitness for work**, **Daily vehicle checklist**, **Dimension & load**) show on the week PDF. Trailer, forklift, and hook-up forms stay in the EWD only. After **Start Other Work** is logged, the ring keeps three tiles (**Start driving**, **Start Rest**, **Load check**); tap **Load check** again for another load. After a form is saved, use **View** to read it, or **Redo** / **Add another** for a new signed record. Vehicle pre-departure is filed under the **vehicle registration**. Load check is **one form per load** (prime + trailers/dollies on that load; six WAHVA columns). **Hook up** is one tick sheet per coupling (14 paper steps; training covers the procedure). **Produce checklist PDFs** downloads **one sheet per signed log** (Fitness for Work named by driver; vehicle and load checks by vehicle rego; Hook up by driver and rego). The date on every file is **week ending** — not signed time. Types stay separate. **Email checklist PDFs** sends those files to **your** address in **Settings → Emails & workshop → Checklist PDF email** (defaults to your sign-in email). Dimension & Load and Hook up can be completed more than once per day; loader CoR is separate from the driver (present sign, pending, or photo gap — no proxy).
5. Type **start km**
...
| Daily checks | Optional day ticks / forms in this order: **Fitness for work**, **Daily vehicle checklist**, **Dimension & load**, then separate **Trailer pre-departure**, **Forklift pre-departure**, and **Hook up** forms (not week-PDF ticks). Signed Fitness for Work, Vehicle / Trailer / Forklift pre-departure, Dimension & Load, and Hook up forms are optional in trial and do not block Start shift. Each form is a **separate** record (not combined). **Fitness for Work** is a ten-point signed declaration filed under your name. **Vehicle pre-departure** is filed under the **vehicle registration**. **Trailer pre-departure** and **Forklift pre-departure** are filed under that plant’s registration. **Load check** is one form per load (Permits, Dimensions, Load security, Stability / rollover risk, Vehicle suitability, Dunnage / friction) — enter the prime mover and every trailer/dolly on that load. Open from **Load check** on the Other work hub or Daily checks. **Add another** for the next load. **Hook up** is one tick sheet per coupling: 14 paper steps. Training covers the procedure. **Completed** / **Fault**. Optional **Faults and observations**. **Driver sign**. Return to your supervisor before leaving the hookup location. **Add another** for the next hook-up. **View** opens a saved form (read only); **Redo** / **Add another** starts a new signed form. **Produce checklist PDFs** downloads **one sheet per signed log**, dated **week ending** (Fitness for Work named by driver; vehicle and load checks by vehicle rego; Hook up by driver and rego). **Email checklist PDFs** sends those files to **your** address in **Settings → Emails & workshop → Checklist PDF email** (defaults to your sign-in email). Vehicle pre-departure asks if you are responsible. Dimension & Load asks if you also loaded and how loader CoR is recorded (present / pending / photos) |
