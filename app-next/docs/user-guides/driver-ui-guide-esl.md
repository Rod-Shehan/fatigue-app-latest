...
- **Last 24-hour break** as an absolute **start and end time** (Perth) — not just a calendar day — under crew, above route setup in Set up day / Edit day. You can change it until you **sign** the week; after that only your manager can amend.
