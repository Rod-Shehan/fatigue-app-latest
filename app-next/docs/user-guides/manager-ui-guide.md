...
| **Rego** | Vehicle catalogue: plate, **Type** (Prime mover / Rigid / Van / Other), **GVM / GCM (t)**, **Axle groups** (2 / 3 / 4), and **WAHVA Accredited** (RAV permit vehicle). Required when adding or editing a rego. Drivers pick the plate on Set up day. |
